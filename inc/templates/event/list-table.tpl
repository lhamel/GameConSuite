...
<th style="white-space: nowrap;"><a href="{$actions.list}&amp;order=s_lname">Gamemaster</a></th>
...
<td class="{$class}">{if $actions.detail}<a href="{$actions.detail}{$v.id_event}">{/if}{$v.s_game}
...
<td class="{$class}">{$constants.events.days[$v.e_day]} {$constants.events.times[$v.i_time]}-{$constants.events.times[$v.endtime]}</td>
