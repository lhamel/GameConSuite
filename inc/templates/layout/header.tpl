...
<tr class="header">
  <td class="header">
    <a href="{$config.page.depth}index.php"><img src="{$config.page.depth}images/swoosh.png" alt="{$config.logo.alt|default:''}" class="logo"/></a>
  </td>
  <td class="header">
    <a href="{$config.page.depth}index.php"><img src="{$config.page.depth}images/title.png" alt="{$config.logo.alt|default:''}" /></a>
