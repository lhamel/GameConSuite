<?php
$location = 'admin/gcs/member/linkassoc.php';
...
foreach ($members as $id => $v) {
  ...
  $members[$id]['name'] = '<a href="index.php?id_member='.$id.'">'.$full.'</a>';
...
$content = <<< EOD
<h2>Envelopes</h2>
<p>Below are the list of all potential envelopes associated with the same user account.  Please
note that physical envelopes will only print if they contain items or transactions.</p>
